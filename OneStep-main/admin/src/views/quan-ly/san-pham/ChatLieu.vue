<template>
  ...
  <tbody>
    <tr v-for="(item, index) in filteredMaterials" :key="item.id">
      ...
      <td>
        <button class="action-btn edit" title="Sửa" @click="editMaterial(index)"><i class="fa fa-edit"></i></button>
        <button class="action-btn delete" title="Xóa" @click="deleteMaterial(index)"><i class="fa fa-trash"></i></button>
      </td>
    </tr>
  </tbody>
</table>
    ...
    <div class="modal-overlay" v-if="showModal">
      <div class="modal">
        ...
        <div class="modal-actions">
          <button @click="addMaterial" class="confirm-btn"><i class="fa fa-check"></i> Xác nhận</button>
